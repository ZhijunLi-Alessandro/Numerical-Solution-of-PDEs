\doxysection{src/csr.c File Reference}
\hypertarget{csr_8c}{}\label{csr_8c}\index{src/csr.c@{src/csr.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=252pt]{csr_8c__incl}
\end{center}
\end{figure}
...
This file incudes functions for creating, freeing, decomposing, matrix-\/vector multiplication, and solving linear systems using iterative methods (Jacobi, Gauss-\/\+Seidel, Conjugate Gradient) for sparse matrices stored in Compressed Sparse Row (CSR) format.
