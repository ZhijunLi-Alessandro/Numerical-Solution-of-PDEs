...
if __name__ == "__main__":
    ...
    visualize_solution(grid_x, grid_y, (ex - sol), title="Neumann Problem Error", save_path="results/Neumann_error.png")
    ...
    # visualize_solution(grid_x, grid_y, (ex - sol), title="Neumann Problem Error", save_path="results/Neumann_error.png", overlay_mask=data_mask)