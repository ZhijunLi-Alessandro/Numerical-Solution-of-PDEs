...
int main() {
    ...
    write_csv_matrix("results/Poisson/data/Dirichlet_solution.csv", data_points, grid->nx, grid->ny);
    write_csv_matrix("results/Poisson/data/Dirichlet_exact.csv", exact_points, grid->nx, grid->ny);
